...
public class LCP019 {
    public int minimumOperations(String leaves) {
        ...
        dp[0][1] = dp[0][2] = dp[1][2] = Integer.MAX_VALUE - 2;
        for (int i = 1; i < n; i++) {
...
//        每部分树叶数量可以不相等，但均需大于等于 1。每次调整操作，小扣可以
//        将一片红叶替换成黄叶或者将一片黄叶替换成红叶。请问小扣最少需要多少次调整操作
//        才能将秋叶收藏集调整完毕。
//
//        示例 1：
...
//        String leaves = "rrryyyrryyyrr";
        String leaves = "yry";
        System.out.println(new LCP019().minimumOperations(leaves));
    }
}
